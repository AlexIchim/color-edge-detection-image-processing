...
public:
	...
	afx_msg void OnLab9Sobel();
	afx_msg void OnLab9Roberts();
	afx_msg void OnProiectEdgedetection();
	afx_msg void OnProiectGradientoverx();
	afx_msg void OnProiectGradi();
	afx_msg void OnL11Sobel();
	afx_msg void OnL11Prewitt();
	afx_msg void OnL11Modul();
	afx_msg void OnL11Modulprewitt();
};
